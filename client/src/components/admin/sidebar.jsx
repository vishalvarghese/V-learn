...
import admindashlogo from '../../asset/admindashlogo.png'
function sidebar() {
  return (
    <div
        id="sidebar"
        class="bg-blue-900 h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
        x-show="sidenav"
      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            V-learn<span class="text-teal-600">.</span>
          </h1> */}
          <div id="profile" class="space-y-3">
            <img
              src={admindashlogo}
              alt="Avatar user"
              class="w-72 h-40   rounded-full mx-auto"
            />
            <div>
              <h2
          ...
          <div id="menu" class="flex flex-col space-y-2">
            {/* <a
              href="/admindashboard"
              class="text-sm font-medium text-white py-2 px-2 hover:bg-teal-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
            >
              <svg
            ...
            >
              ...
              <span class="">Report management</span>
            </a>
            ...
            <div>
                 <a href="">
                 <p class="text-xs text-black font-bold text-center">Log Out</p>
                 </a>
            </div>
