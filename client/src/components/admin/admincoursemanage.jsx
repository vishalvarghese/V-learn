        ...
        <table class="w-full border">
            ...
            <tbody>
                ...
                <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
                    ...
                    <td class="p-2 border-r">{obj.creatorName}</td>
                    <td class="p-2 border-r"><button onClick={()=>setShowModal(true)} className='p-2 bg-blue-500 rounded-xl text-white'>View</button> </td>
