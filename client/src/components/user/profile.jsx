...
function Profile() {
  ...
  console.log(userDetail, "gggggggggggg");
                ...
                <div className="px-6">
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center">
                      <div className="relative">
                        <img
                          ...
                          src={PF + userDetail.profilePicture}
                    ...
                    <div className="w-full lg:w-4/12 px-4 lg:order-1">
                      <div className="flex justify-center py-4 lg:pt-4 pt-8">
                        ...
                        <div onClick={(e) => { setShowRequest(!showRequest);  }} className="cursor-pointer lg:mr-4 p-3 text-center">
                          <span className="text-xl font-bold block uppercase tracking-wide text-gray-700">
                            {userDetail.connection_Request?.length}
                          </span>
                  ...
                  <div className="mt-10 py-10 border-t border-gray-300 text-center">
                    <div className="flex flex-wrap justify-center">
                      ...
                      <div className='text-left mt-9 w-3/4'>
